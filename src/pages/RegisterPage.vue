...
const onSubmit = handleSubmit(async (values) => {
    ...
    try {
        ...
        formError.value = err instanceof Error ? err.message : 'Erro ao criar conta'
    }
})
</script>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-zinc-800 border border-zinc-700 rounded-xl p-8">
                ...
                <form @submit.prevent="onSubmit" class="flex flex-col gap-5">
                    ...
                    <AppInput v-model="confirmPassword" v-bind="confirmPasswordAttrs" label="Confirmar Senha"
                        type="password" placeholder="••••••••" :error="errors.confirmPassword" />
